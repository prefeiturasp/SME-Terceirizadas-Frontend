...
export const getResumoPendenciasDREInclusaoDeAlimentacao = async (
  ...
  const resumoAvulsa = await getResumoPendenciasDREInclusaoDeAlimentacaoAvulsa(filtro)
  const resumoContinua = await getResumoPendenciasDREInclusaoDeAlimentacaoContinua(filtro)
