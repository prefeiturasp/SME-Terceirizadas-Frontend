...
const SET_DADOS_RESULTADOS =
  "SME-Terceirizadas-Frontend/controle-restos/SET_DADOS_RESULTADOS";
const SET_TOTAL_RESULTADOS =
  "SME-Terceirizadas-Frontend/controle-restos/SET_TOTAL_RESULTADOS";

const SET_EXIBIR_RESULTADOS =
  "SME-Terceirizadas-Frontend/controle-restos/SET_EXIBIR_RESULTADOS";
const SET_FILTROS =
  "SME-Terceirizadas-Frontend/dieta-especial/controle-restos/SET_FILTROS";

const SET_PAGE = "SME-Terceirizadas-Frontend/controle-restos/SET_PAGE";

const SET_ESCOLAS = "SME-Terceirizadas-Frontend/controle-restos/SET_ESCOLAS";

const SET_DIRETORIAS_REGIONAIS =
  "SME-Terceirizadas-Frontend/controle-restos/SET_SET_DIRETORIAS_REGIONAIS";

const SET_MEUS_DADOS =
  "SME-Terceirizadas-Frontend/controle-restos/SET_SET_MEUS_DADOS";

const RESET = "SME-Terceirizadas-Frontend/controle-restos/RESET";
...
// Reducer
export default function controleRestosReducer(
  state = initialValues,
  action = {}
) {
  switch (action.type) {
