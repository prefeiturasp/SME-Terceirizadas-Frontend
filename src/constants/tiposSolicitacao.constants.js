...
export const TIPOS_SOLICITACAO_LISTA = [
  {
    solicitacao: TIPOS_SOLICITACAO_LABEL.INCLUSAO_DE_ALIMENTACAO,
    link: INCLUSAO_ALIMENTACAO
  },
  {
    solicitacao: TIPOS_SOLICITACAO_LABEL.ALTERACAO_DE_CARDAPIO,
    link: ALTERACAO_CARDAPIO
  },
  {
    solicitacao: TIPOS_SOLICITACAO_LABEL.SOLICITACAO_DE_KIT_LANCHE_PASSEIO,
    link: SOLICITACAO_KIT_LANCHE
  },
  {
    solicitacao: TIPOS_SOLICITACAO_LABEL.INVERSAO_DE_DIA_DE_CARDAPIO,
    link: INVERSAO_CARDAPIO
  },
  {
    solicitacao: TIPOS_SOLICITACAO_LABEL.SOLICITACAO_UNIFICADA,
    link: SOLICITACAO_KIT_LANCHE_UNIFICADA
  },
  {
    solicitacao: TIPOS_SOLICITACAO_LABEL.SUSPENSAO_DE_ALIMENTACAO,
