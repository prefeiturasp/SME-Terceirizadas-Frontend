...
test("test mesesToMesEAnoString", () => {
  ...
  expect(mesesToMesEAnoString(1)).toEqual("1 mês");
  expect(mesesToMesEAnoString(2)).toEqual("2 meses");
  expect(mesesToMesEAnoString(3)).toEqual("3 meses");
  expect(mesesToMesEAnoString(11)).toEqual("11 meses");
  expect(mesesToMesEAnoString(12)).toEqual("1 ano");
  expect(mesesToMesEAnoString(13)).toEqual("1 ano e 1 mês");
  expect(mesesToMesEAnoString(14)).toEqual("1 ano e 2 meses");
  expect(mesesToMesEAnoString(15)).toEqual("1 ano e 3 meses");
  expect(mesesToMesEAnoString(23)).toEqual("1 ano e 11 meses");
  expect(mesesToMesEAnoString(24)).toEqual("2 anos");
  expect(mesesToMesEAnoString(25)).toEqual("2 anos e 1 mês");
  expect(mesesToMesEAnoString(26)).toEqual("2 anos e 2 meses");
  expect(mesesToMesEAnoString(27)).toEqual("2 anos e 3 meses");
  expect(mesesToMesEAnoString(35)).toEqual("2 anos e 11 meses");
  expect(mesesToMesEAnoString(36)).toEqual("3 anos");
});
...
test("test mesesForaDasFaixas", () => {
  const faixas1 = [{ inicio: 2, fim: 5 }, { inicio: 8, fim: 11 }];
