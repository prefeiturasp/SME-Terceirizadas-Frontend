...
import { NUTRISUPERVISAO, SOLICITACOES_CANCELADAS } from "configs/constants";
import SolicitacoesPorStatusGenerico from "components/screens/SolicitacoesPorStatusGenerico";
import {
  CARD_TYPE_ENUM,
  ICON_CARD_TYPE_ENUM,
} from "components/Shareable/CardStatusDeSolicitacao/CardStatusDeSolicitacao";
import { getSolicitacoesCanceladasNutrisupervisao } from "services/painelNutricionista.service";
...
export default () => (
  <Page titulo={atual.titulo} botaoVoltar>
    ...
    <SolicitacoesPorStatusGenerico
      ...
      titulo={"Canceladas"}
      getSolicitacoes={getSolicitacoesCanceladasNutrisupervisao}
