...
import { consultaRelatorioControleSobrasBruto } from "services/controleSobras.service";

const ControleSobras = ({
  dadosResultados,
  setDadosResultados,
  exibirResultados,
  setExibirResultados,
  ...
  const fetchData = async (filtros) => {
    ...
    try {
      const response = await consultaRelatorioControleSobrasBruto({
        ...getFiltros(filtros),
      });
...
const mapStateToProps = (state) => {
  return {
    dadosResultados: state.controleSobras.dadosResultados,
    exibirResultados: state.controleSobras.exibirResultados,
    totalResultados: state.controleSobras.totalResultados,
    filtros: state.controleSobras.filtros,
    page: state.controleSobras.page,
    meusDados: state.controleSobras.meusDados,
  };
};
