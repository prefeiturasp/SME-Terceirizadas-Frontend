...
import {
  consultaTiposRecipiente,
  getNomesTiposRecipiente,
} from "services/tipoRecipiente.service";
...
export default () => {
  ...
  async function fetchData() {
    const respItems = await consultaTiposRecipiente(initialValues);
    setResultado(respItems.data.results);
    setTotal(respItems.data.count);
    const respNomes = await getNomesTiposRecipiente();
