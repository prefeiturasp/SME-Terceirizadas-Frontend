...
export default class ModalExcluirComboSubstituicoes extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    const { showModal, closeModal, deletaComboSubstituicao, combo, indice } =
      this.props;
    return (
        ...
        <Modal.Footer>
          <div className="botao-footer-modal">
            ...
            <Botao
              ...
              onClick={() => {
                deletaComboSubstituicao(combo, indice);
                closeModal();
              }}
            />
          </div>
