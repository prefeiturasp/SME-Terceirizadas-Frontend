...
import DashboardNutriManifestacao from "./DashboardNutriManifestacao";
import { getLotesSimples } from "../../../services/lote.service";

class DashboardNutriManifestacaoContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      vision_by: [
  ...
  render() {
    return <DashboardNutriManifestacao {...this.state} {...this.props} />;
  }
}

export default DashboardNutriManifestacaoContainer;
