...
import PainelGestaoAlimentacao from "./PainelGestaoAlimentacao";
import { getLotesSimples } from "../../../services/lote.service";

class GestaoDeAlimentacaoDashboard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      vision_by: [
  ...
  render() {
    return <PainelGestaoAlimentacao {...this.state} {...this.props} />;
  }
}

export default GestaoDeAlimentacaoDashboard;
