...
import { Rascunhos } from "./Escola/Formulario/componentes/Rascunhos";
import "./style.scss";
...
class InclusaoDeAlimentacao extends Component {
  ...
  handleField(field, value, id) {
    ...
    if (field === "data") {
      inclusoes[indiceDiaMotivo]["data_touched"] = true;
    }
          ...
          <form onSubmit={this.props.handleSubmit} onKeyPress={this.onKeyPress}>
            ...
            <div className="card solicitation mt-2">
              <div className="card-body">
                      ...
                      <section className="row">
                        ...
                        <div className="col-4 pr-0">
                          {!ehMotivoContinuo && ehMotivoContinuo !== null && (
                            <div className="row">
                              <div className={`col-${indice > 0 ? "8" : "12"}`}>
                                <Field
                      ...
                      {diaMotivo.outroMotivo && (
                        <div className="mb-3">
                          <Field
                            ...
                            validate={required}
                          />
                          {this.state.acimaDoLimite.includes(diaMotivo.id) && (
                ...
                {inclusoes[0].motivo && !primeiroEhMotivoContinuo && (
                  <Botao
                ...
                <div className="row">
                  ...
                  <div
                    className={`col-${primeiroEhMotivoContinuo ? "3" : "6"}`}
                  >
                    Tipo de Alimentação
                  </div>
                  ...
                  return (
                    ...
                    >
                      <div className="row">
                        ...
                        {primeiroEhMotivoContinuo && <div className="col-3" />}
                        {!primeiroEhMotivoContinuo && (
                          <div className="col-6">
