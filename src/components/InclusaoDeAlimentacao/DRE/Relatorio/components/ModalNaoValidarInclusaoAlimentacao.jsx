...
import {
  naoValidarInclusaoNormalDRE,
  naoValidarInclusaoContinuaDRE
} from "../../../../../services/inclusaoDeAlimentacaoAvulsa.service";
import { toastSuccess, toastError } from "../../../../Shareable/Toast/dialogs";

export class ModalNaoValidarInclusaoAlimentacao extends Component {
  constructor(props) {
    super(props);
    this.state = {
      justificativa: ""
  ...
  async naoValidarInclusaoDeEscolaDRE(uuid, ehInclusaoContinua) {
    const { justificativa } = this.state;
    let resp = "";

    ehInclusaoContinua
      ? (resp = await naoValidarInclusaoContinuaDRE(uuid, justificativa))
      : (resp = await naoValidarInclusaoNormalDRE(uuid, justificativa));
      ...
      <Modal dialogClassName="modal-90w" show={showModal} onHide={closeModal}>
        ...
        <Modal.Footer>
          <Botao
            ...
            onClick={() => {
              this.naoValidarInclusaoDeEscolaDRE(uuid, ehInclusaoContinua);
            }}
