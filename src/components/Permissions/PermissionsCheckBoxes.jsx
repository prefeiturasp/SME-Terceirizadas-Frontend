...
class PermissionsCheckBoxes extends Component {
  ...
  render() {
    const { openAddFoodFeature, openMenuChangeFeature, openMealKitFeature,
            openDayMenuChangeFeature, openMenuSuspensionFeature, openMenuSpecialDietFeature,
            openOrderDashboardFeature, openSpecialDietDashboardFeature } = this.state;
    const { type, subtype } = this.props.match.params;
    return (
      <div className="accordion">
        <h3 className="category">Permissões de {this.translate(type)} - {this.translate(subtype)}</h3>
        <div className="card">
          ...
          <div className="card-header">
            <h5 className="mb-0">
              <button
                className="btn btn-link"
                onClick={() =>
                  this.setState({ ...this.state, openMealKitFeature: !openMealKitFeature })
                }
                type="button"
          ...
          <div className="card-header">
            <h5 className="mb-0">
              <button
                className="btn btn-link"
                onClick={() =>
                  this.setState({ ...this.state, openDayMenuChangeFeature: !openDayMenuChangeFeature })
                }
                type="button"
          ...
          <div className="card-header">
            <h5 className="mb-0">
              <button
                className="btn btn-link"
                onClick={() =>
                  this.setState({ ...this.state, openOrderDashboardFeature: !openOrderDashboardFeature })
                }
                type="button"
          ...
          <div className="card-header">
            <h5 className="mb-0">
              <button
                className="btn btn-link"
                onClick={() =>
                  this.setState({ ...this.state, openMenuSuspensionFeature: !openMenuSuspensionFeature })
                }
                type="button"
          ...
          <div className="card-header">
            <h5 className="mb-0">
              <button
                className="btn btn-link"
                onClick={() =>
                  this.setState({ ...this.state, openMenuSpecialDietFeature: !openMenuSpecialDietFeature })
                }
                type="button"
          ...
          <div className="card-header">
            <h5 className="mb-0">
              <button
                className="btn btn-link"
                onClick={() =>
                  this.setState({ ...this.state, openSpecialDietDashboardFeature: !openSpecialDietDashboardFeature })
                }
                type="button"
                aria-controls="order-dashboard-feature-toggle"
